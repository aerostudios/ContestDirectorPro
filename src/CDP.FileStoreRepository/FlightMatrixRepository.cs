...
namespace CDP.ContestHost.FileStoreRepository
{
    ...
    public sealed class FlightMatrixRepository : RepositoryBase, IFlightMatrixRepository
    {
        ...
        /// <summary>
        /// Deletes the flight matrix from the file.
        /// </summary>
        ...
        /// <summary>
        /// Reads a flight matrix associated with a contest from the flight matrix file.
        /// </summary>
        ...
        /// <summary>
        /// Updates the specified flight matrix in the file.
        /// </summary>
