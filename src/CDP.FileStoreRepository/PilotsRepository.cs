...
namespace CDP.ContestHost.FileStoreRepository
{
    ...
    public sealed class PilotFileSystemRepository : RepositoryBase, IPilotRepository
    {
        ...
        /// <summary>
        /// Gets the requested pilot by pilot id from the file.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns></returns>
