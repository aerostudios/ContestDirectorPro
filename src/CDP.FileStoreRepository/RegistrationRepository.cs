...
namespace CDP.ContestHost.FileStoreRepository
{
    ...
    public sealed class RegistrationRepository : RepositoryBase, IPilotRegistrationRepository
    {
        ...
        public RegistrationRepository(string fileName, ICache cache, ILoggingService logger) : base(fileName, cache, logger) { }

        /// <summary>
        /// Adds a set of pilot registrations to the registrations file.
        /// </summary>
        ...
        public async Task<Result<IEnumerable<PilotRegistration>>> CreateAsync(IEnumerable<PilotRegistration> pilotsToRegister)
        {
            ...
            // Remove any registrations that currently exist for the contest
            allPilotRegistrations = allPilotRegistrations.Where(reg => reg.ContestId != pilotsToRegister.First().ContestId).ToList();
        ...
        /// <summary>
        /// Adds a single registration to the registration file.
        /// </summary>
        ...
        public async Task<Result<PilotRegistration>> CreateAsync(PilotRegistration pilotToRegister)
        {
            ...
            pilotToRegister.Id = base.GenerateId();
        ...
        /// <summary>
        /// Removes a set of pilot registrations from the file.
        /// </summary>
        ...
        /// <summary>
        /// Removes a single pilot registration from the file.
        /// </summary>
        ...
        /// <summary>
        /// Gets all the pilot registrations for a contest.
        /// </summary>
