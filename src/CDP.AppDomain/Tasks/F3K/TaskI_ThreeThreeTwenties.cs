...
namespace CDP.AppDomain.Tasks.F3K
{
    ...
    /// <summary>
    /// Defines Task I in F3K, Three - Three's
    /// </summary>
    public sealed class TaskI_ThreeThreeTwenties : TaskBase
    {
        #region Properties
        ...
        /// The description.
        /// </value>
        public override string Description => "Best 3 flights in a 10 minute window.  Max flight time of 200 seconds (three minutes, twenty seconds).";
        ...
        /// The name.
        /// </value>
        public override string Name => "Task I - Three 3:20's";
        ...
        /// </summary>
        public TaskI_ThreeThreeTwenties()
        {
            base.Id = "622c9966-fbae-4d86-8389-ad9cccc9397d";
            InitGates();
        }
        ...
        private void InitGates()
        {
            for (var i = 0; i < 3; ++i)
            {
                ScoredTimeGates.Add(new TimeGate() { Ordinal = i, Time = TimeSpan.FromSeconds(200) });
            }
